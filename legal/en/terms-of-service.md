...
| Tier | Key Features |
|------|-------------|
| Starter | One active loyalty card template, one location, small team of scanners, unlimited customers and scans |
| Growth | One active loyalty card template, one location, larger scanner team, promotional broadcasts (monthly quota), basic analytics (trends and peak hours) |
| Pro | Everything in Growth, with multiple active card templates, multi-location, advanced analytics (retention, customer frequency, redemption, per-location) and unlimited broadcasts |
...
**For professional Business Users**, the dispute shall be submitted to the competent French courts.
