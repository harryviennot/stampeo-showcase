...
Ces trois règles suffisent pour démarrer. Pour le détail — chiffrer ce que le programme vous coûte par euro encaissé, et construire un menu à plusieurs paliers — c'est dans notre [guide du programme de fidélité à points](/blog/programme-fidelite-a-points).

Une fois le barème posé, il reste à monter la carte elle-même : [comment créer la carte à points dans le wallet](/blog/carte-fidelite-points-wallet) reprend la configuration étape par étape.
