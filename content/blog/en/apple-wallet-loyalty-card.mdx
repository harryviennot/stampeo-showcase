...
description: "No app download, no lost cards. Staff scan your QR code, stamp added in one second. Here's how Apple Wallet loyalty cards work and what they cost."
...
faqs:
  ...
  - question: "How much does it cost?"
    answer: "DIY with an Apple Developer account starts at $99/year (roughly £80+) plus technical work. Platforms typically run around £20–60/month depending on features."
  ...
  - question: "What if someone loses their phone or gets a new one?"
    answer: "Wallet passes sync across devices via iCloud, so a new iPhone on the same Apple ID usually keeps the card. And with Stampeo, if a customer ever loses their pass, they re-enter their email on your card page and get it back with all their stamps (as long as you collect email at sign-up)."
...
Next time you're behind the counter, pay attention to how people pay. Phones. So many phones. In the UK, more than half of adults now use a mobile wallet (UK Finance 2025). That's a lot of people already tapping their phone every time they walk through your door.
...
**Apple Wallet already has reach in the UK.** iPhone market share in the UK sits at roughly half (StatCounter 2025), so a large chunk of your customers carry a device that supports this natively. Not everyone — we'll get to Android — but a real starting point.
...
One thing we've noticed working with businesses on Stampeo: the places where staff consistently mention the card see two to three times more sign-ups than those relying on the QR code alone. Sounds obvious. But the reminder genuinely makes the difference.
...
Depends. DIY with an Apple Developer account starts at $99/year (roughly £80+) plus technical work. Platforms typically run around £20–60/month depending on features. With Stampeo, you get a month free, then €20/month on Starter. Whatever route you go, calculate it against the value of even one or two extra visits per customer per month. Usually pencils out quickly.
</FAQItem>
...
Wallet passes sync across devices via iCloud (when the Wallet setting is enabled), so a new iPhone on the same Apple ID usually keeps the card. And if a pass is ever lost, with Stampeo the customer re-enters their email on your card page and gets it back with all their stamps intact — as long as you collected their email at sign-up. Takes seconds.
</FAQItem>
