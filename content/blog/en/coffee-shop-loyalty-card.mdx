...
faqs:
  ...
  - question: "How much does a digital coffee shop loyalty card cost?"
    answer: "It varies by platform — expect roughly £20–60 a month for a proper plan. Stampeo charges no per-customer or per-stamp fees and gives every new business a free month with no card required. After that, Starter is €20/month and Growth €40/month, with no per-customer or per-stamp fees."
---
...
We built Stampeo for exactly this — independent cafés that want a proper loyalty card without building an app or wrestling with their till system. Every new café gets a month free to get going, then €20/month on Starter with no commitment. If you're tired of reprinting paper cards, it's worth a look.
...
It varies by platform — expect roughly £20–60 a month for a proper plan. Stampeo charges no per-customer or per-stamp fees and gives every new business a free month with no card required. After that, Starter is €20/month and Growth €40/month, with no per-customer or per-stamp fees.
</FAQItem>
...
So keep it simple. For a café, stamps beat points — "buy 9, get the 10th free" is instant to understand (Stampeo does points too, but you rarely need them over a counter). Eight to ten of them. A reward you'd happily give a favourite customer. A wallet card that won't slow your queue. Then tell people about it.
