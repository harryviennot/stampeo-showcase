...
description: "The app-download problem kills most loyalty programs. Here's why wallet-native cards work better, and how to set one up, reward customers, and track who's coming back."
...
faqs:
  ...
  - question: "What about GDPR and customer data?"
    answer: "When customers add a wallet loyalty card, the data you collect depends on your settings — from just a unique card identifier to an email (the recommended default with Stampeo) and optionally a name. Any platform you use should be GDPR-compliant."
...
This guide covers all of it. How a digital loyalty card for small business actually works day to day, what it costs, what type of program makes sense for you, and how to get customers to sign up without making things awkward at the till. No fluff, no jargon, and honest about where things can go wrong. And if you'd rather skip straight to the setup, our walkthrough on [how to create a digital loyalty card](/en/blog/how-to-create-digital-loyalty-card) takes you through it step by step.
...
<StatBox value="25–95%" label="profit lift from a 5% increase in customer retention (Bain & Company)" />

Here's why. For most small businesses, a large share of revenue comes from repeat customers, not one-off visitors. And the likelihood of someone returning climbs with each visit they make:

- A first-time customer is the least likely to come back
- Each repeat visit makes the next one meaningfully more likely
- By the third or fourth visit, you're well on the way to a regular
- By the fifth, the habit has usually set
...
> Winning a new customer costs several times more than keeping one you already have.
...
According to research from CodeBroker, 43% of consumers say the physical card is the biggest friction point in loyalty programmes. And plenty are never completed at all — lost, forgotten, or left in a jacket pocket long before the last stamp.

<StatBox value="43%" label="of consumers say the physical card is their biggest loyalty friction (CodeBroker)" />

That means a lot of the cards you hand out never reach a reward. They end up in the washing machine, the bin, or last winter's coat.
...
That said, you're not locked in. A platform like Stampeo runs both stamps and points, and lets you **switch between them without your customers re-downloading anything** — so you can start with stamps today and move to points later if your average spend ever makes them worth it.
...
This isn't a guess. Business owners who've tried app-based loyalty consistently report the same thing: customers hear "download our app" and politely decline. You lose a big chunk of potential sign-ups at that single step. Could you afford to lose most of your potential loyalty members before they even start?
...
The customer scans a QR code, taps "Add to Wallet," and it's done. The card sits alongside their bank cards and boarding passes. It updates in real time when they earn a stamp. And with mobile wallets now standard on virtually every smartphone, this isn't a niche feature — it's where consumers already are.
...
**Paper stamp cards** cost roughly £30-80 per batch of 500, depending on design and quality. That sounds cheap until you factor in the reorder cycle — most businesses go through several batches a year. Plus a lot of those cards never reach a reward, so you're paying to print cards that mostly get lost. There's no data, no re-engagement capability, and no fraud prevention. Over a year, you might spend £150-300 on printing alone, with nothing to show for it but a vague sense that "people seem to like the stamp card."
...
When you run the numbers, a digital solution at £20-60 per month often costs similar to or less than ongoing paper card printing — but gives you data, fraud prevention, and the ability to actually reach your customers.
{/* TODO: link to /en/blog/loyalty-program-cost when published */}

If you're evaluating options, we built Stampeo specifically for independent businesses in this position. Every new business gets one month free, no card required. After that it's €20/month on Starter, with no per-customer or per-visit fees.
...
When customers add a wallet loyalty card, the data you collect depends on your settings — it can be as little as a unique card identifier, or it can include an email (useful for pass recovery and the occasional update) and, if you choose, a name. With Stampeo, email-only is the recommended default. Any platform you use should be GDPR-compliant, and it's worth asking specifically about data storage and customer rights before signing up. Keep it simple and transparent.
</FAQItem>
