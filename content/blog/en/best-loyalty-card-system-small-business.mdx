...
Where wallet-native fits less neatly: if you want loyalty rules that fire **automatically** off your sales data — say, instantly rewarding anyone who spends over £50 in a single visit — POS-integrated does that natively. Wallet-native platforms do support points now (your staff key in the amount spent at the till and the card converts it to points), but the spend is entered by hand, not read straight from the register.
...
- Need loyalty rules that read **automatically** from your till's transaction data (wallet-native supports spend-based points, but staff key the amount in by hand)
