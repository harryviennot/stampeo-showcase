...
The standard trial is 1 month free, no credit card. After that it's €20/month on Starter, with no per-customer or per-visit fees. The card designer has a live wallet preview so you can see exactly what your customers will see before you launch.
