...
faqs:
  ...
  - question: "Is a wallet-based loyalty card free to set up?"
    answer: "It depends on the platform. We're currently running a founder's programme — a month free, then 50% off Starter or Growth, locked in for life. Other platforms have different pricing models."
---
...
Here's something that doesn't get talked about enough: app downloads have been declining globally for five consecutive years (Appfigures). After years of relentless growth, the numbers have dropped every single year since 2020.

People aren't downloading fewer apps because they don't use their phones. They're just tired of it. The phone is already crammed with apps, half of them unused, and the last thing anyone wants is another one asking for notifications and storage space.

And the apps they do download? They don't stick around. By day 30, only around 3% of users are still active (Pushwoosh 2025).
...
CodeBroker's consumer research is blunt about this: 70% of consumers say they want mobile loyalty without having to download or log into an app. They want simpler options — wallet passes, anything that doesn't require yet another download.

And 43% said the biggest hassle with loyalty programmes was losing the physical card itself (CodeBroker).
...
Removing the app-download step has been reported to lift loyalty take-up several times over — from low single digits to comfortably double-digit percentages — just by eliminating that one barrier.

<StatBox value="70%" label="of consumers want mobile loyalty without an app login (CodeBroker)" />
...
It depends on the platform. We're currently running a founder's programme — a month free, then 50% off Starter or Growth, locked in for life. Other platforms have different pricing models, but most offer some kind of trial period so you can test before committing.
</FAQItem>
