...
It varies by platform. Paid plans for independent businesses typically run around £20–60 per month, which includes analytics, push notifications, and unlimited customers. We're currently running a founder's program — a month free, then 50% off Starter or Growth for life. Worth a look if you're in the early stages.
</FAQItem>
