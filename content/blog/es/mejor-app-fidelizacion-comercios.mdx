...
La prueba estándar es de un mes, sin tarjeta bancaria. Mientras seguimos incorporando comercios de cerca, los que entran en el programa fundador se quedan con un 50 % de descuento de por vida en Starter o Growth. Si prefieres ir directo al montaje, tenemos el paso a paso en [cómo crear una tarjeta de fidelidad digital](/es/blog/como-crear-tarjeta-fidelidad-digital).
