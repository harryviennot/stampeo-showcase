...
{/* TODO (STA-359): enlazar a /es/blog/tarjeta-fidelidad-cafeteria, /es/blog/tarjeta-fidelidad-restaurante y /es/blog/programa-fidelidad-peluqueria cuando se publiquen. Usa EXACTAMENTE estos slugs: son los que Search Console ya ha rastreado. */}
...
**Las tarjetas de fidelidad que viven en el wallet.** Son tarjetas digitales que viven directamente en el Apple Wallet o el [Google Wallet](/es/blog/google-wallet-tarjeta-fidelidad) de tu cliente, las apps que ya vienen instaladas en su teléfono. Sin descargas. Sin crear cuenta. Sin iniciar sesión.
...
<CallToAction title="Prueba una tarjeta de fidelidad digital para tu comercio" buttonText="Empezar gratis" href="/onboarding" />
