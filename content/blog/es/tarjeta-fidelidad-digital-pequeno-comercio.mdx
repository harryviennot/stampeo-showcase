...
**Las tarjetas de fidelidad que viven en el wallet.** Son tarjetas digitales que viven directamente en el [Apple Wallet](/es/blog/apple-wallet-tarjeta-fidelidad) o el [Google Wallet](/es/blog/google-wallet-tarjeta-fidelidad) de tu cliente, las apps que ya vienen instaladas en su teléfono. Sin descargas. Sin crear cuenta. Sin iniciar sesión.
