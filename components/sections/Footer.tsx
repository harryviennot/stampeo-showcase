...
export function Footer() {
  return (
    <footer className="py-16 sm:py-20 border-t border-[var(--border)]">
      <Container>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-10 mb-16">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-sm text-[var(--muted-foreground)] leading-relaxed">
              Digital loyalty cards for Apple Wallet and Google Wallet. No app
              needed.
            </p>
          </div>
          ...
          {Object.entries(footerLinks).map(([category, links]) => (
            <div key={category}>
              <h3 className="font-semibold text-[var(--foreground)] mb-5">
                {category}
              </h3>
        ...
        <div className="pt-8 border-t border-[var(--border)] flex flex-col sm:flex-row items-center justify-between gap-6">
          <p className="text-sm text-[var(--muted-foreground)]">
            &copy; {new Date().getFullYear()} Stampeo. All rights reserved.
          </p>
