...
const themes: Theme[] = [
  // Café — moody, specialty coffee bar
  {
    cardBg: "#12100E", // near-black espresso
    cardText: "#F5F5F4",
    cardMuted: "rgba(245,245,244,0.6)",
    accentPill: "rgba(217,119,6,0.22)", // burnt amber
    walletBg: "#1F1B18",
    walletAccent: "#D97706",
    walletIcon: "#FFF7ED",
    walletStamps: 9,
  ...
  // Restaurant — modern, slightly upscale bistro

  {
    cardBg: "#111827", // deep slate, more modern than blue
    cardText: "#F9FAFB",
    cardMuted: "rgba(249,250,251,0.6)",
    accentPill: "rgba(192,132,252,0.18)", // subtle violet accent
    walletBg: "#1F2937",
    walletAccent: "#C084FC",
    walletIcon: "#FFFFFF",
    walletStamps: 12,
  ...
  // Salon de thé — elegant, floral & calm
  {
    cardBg: "#EEF3EC", // pale botanical green instead of pink cliché
    cardText: "#243326",
  ...
  // Boulangerie — rustic artisan bakery
  {
    cardBg: "#F2E3C6", // flour + parchment tone
    cardText: "#2F2419",
    cardMuted: "rgba(47,36,25,0.6)",
    accentPill: "rgba(180,83,9,0.18)", // baked crust brown
    walletBg: "#E7D3A8",
    walletAccent: "#B45309",
    walletIcon: "#FFFDF7",
    walletStamps: 7,
              ...
              <ScrollReveal key={sector.name} delay={index * 80}>
                ...
                >
                  ...
                  >
                    ...
                    >
                      <ScaledCardWrapper targetWidth={100} >
                        <WalletCard
                          design={{
                  ...
                  <div className="flex flex-col gap-3 px-6 pb-6 pt-2 flex-1">
